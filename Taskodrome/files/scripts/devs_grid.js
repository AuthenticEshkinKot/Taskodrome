...
function draw() {
  ...
  if (panelCanvas.width > parseInt(window.getComputedStyle(tab_c1).getPropertyValue("width"))) {
    m_parentSize.width = parseInt(window.getComputedStyle(tab_c1).getPropertyValue("width"));
    draw();
  } else {
    m_mainPanel.update();
  }
